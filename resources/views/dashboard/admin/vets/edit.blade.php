        ...
        <div class="col-lg-8">
            <div class="card-modern">
                <div class="card-header-modern">
                    <span>Edit Vet: {{ $vet->name }}</span>
                    <a href="{{ route('vets.index') }}" class="btn btn-modern btn-outline-light">Go Back</a>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('users.update', $vet->id) }}" method="POST">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('vets.index') }}" class="btn btn-outline-secondary btn-modern">Cancel</a>
                            <button type="submit" class="btn btn-primary btn-modern">Update Vet</button>
                        </div>
